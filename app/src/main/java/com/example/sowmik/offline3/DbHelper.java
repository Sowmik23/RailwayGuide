...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public Cursor SearchByName(final String a){
        ...
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        Cursor cursor = sqLiteDatabase.rawQuery(" SELECT * FROM " + TABLE_NAME + " WHERE  ( " + TRAIN_NAME + " = '"+str1+"' ) ",null);

        return cursor;

    }

    public Cursor SearchByNumber(final String a){


        final String str1 = a;

        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        Cursor cursor = sqLiteDatabase.rawQuery(" SELECT * FROM " + TABLE_NAME + " WHERE  ( " + TRAIN_NO + " = '"+str1+"' ) ",null);
    ...
    public Cursor SearchByDepartureArrival(final String a,final String b){
